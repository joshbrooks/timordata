...
class PathMethodTests(TestCase):
    ...
    def setUp(self):
        ...
        self.TestDistrict = Place.objects.create(pcode = 1, name = 'Aileu', path ='AIL', geom=g, envelope=envelope)
        self.TestSubDistrict = Place.objects.create(pcode = 101, name = 'Aileu', path ='AIL.AIL', geom=g, envelope=envelope)
        self.TestSuco = Place.objects.create(pcode = 10101, name = 'Aileu', path ='AIL.AIL.AIL', geom=g, envelope=envelope)
    
        Place.objects.create(pcode=2, name='Covalima', path='COV', geom=g, envelope=envelope)
        Place.objects.create(pcode=201, name='Covalima', path='COV.COV', geom=g, envelope=envelope)
        Place.objects.create(pcode=20101, name='Covalima', path='COV.COV.COV', geom=g, envelope=envelope)
    ...
    def test_add_child(self):
        ...
        p = Place(pcode =101, name = 'Aileu sub', path ='AIL.AIL', geom=g, envelope=envelope)
        p.save()
    ...
    def test_needparent(self):
        ...
        '''
        p = Place(pcode = 20101, name = 'Fail this suco', path ='AIN.AIL.AIL', geom=g, envelope=envelope)
        p.save()
    ...
    def test_delete_parent_and_child(self):
        ...
        p.delete()
        self.assertEqual(
            Place.objects.extra(where=["path LIKE %s"], params=['COV%']).count(),
            0)
    ...
    def test_move_to(self):
        ...
        self.assertEqual(
            Place.objects.extra(where=["path LIKE %s"], params=['AIL.%']).count(),
            0)

        
        self.assertEqual(
            Place.objects.extra(where=["path = %s"], params=['AAA.AIL']).count(),
            1)
            
        self.assertEqual(
            Place.objects.extra(where=["path = %s"], params=['AAA.AIL.AIL']).count(),
            1)
            
        self.assertEqual(
            Place.objects.extra(where=["path = %s"], params=['AIL.AIL.AIL']).count(),
            0)
