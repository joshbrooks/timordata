...
publication = [
    ...
    url(
        r"^(?P<pk>[0-9]+)/ajax/$", views.PublicationDetail.as_view(), name="detail-ajax"
    ),
    url(r"^suggested_publication/$", views.suggested_publications),
    url(
        r"^suggested_publication/(?P<suggestion_pk>[0-9]+)/$",
        views.suggested_publication,
    ),
...
version = [
    ...
    url(
        r"^thumbnail/(?P<version_pk>\d+)/(?P<language>\w+)$",
        views.version_thumbnail,
        name="thumbnail",
    ),
    ...
    url(r"^thumbnail_nginx/$", views.version_thumbnail_nginx, name="nginx_thumbnail"),
    url(
        r"^(?P<pk>[0-9]+)/page/(?P<page>\d+)/(?P<language>\w+)$",
        views.version_page,
        name="s",
    ),
]

untl = [url(r"^$", views.publicationlist, name="list")]
