...
class ProjectTestCase(FoxCase):
    ...
    def setUp(self):
        ProjectType.objects.create(description="Active")
    ...
    def test_project_suggest(self):
        ...
        fox.form(
            "project-form",
            (
                ("name_en", "National Database Project"),
                (
                    "description_en",
                    "Providing information about NGOs and projects in Timor",
                ),
            ),
        )
...
class SuggestOrganizationFormTestCase(TestCase):
    ...
    fixtures = [
        "organizationclass.json",
        "organizations_10.json",
        "projecttype",
        "projectstatus",
        "project_100",
        "projectproperties",
    ...
    def test_suggestion_update(self):
        ...
        c = Client()
        response = c.post(
            "/suggest/suggest/", serialize_to_post(serialized_organization_suggestion)
        )
