...
organization = [
    ...
    url(
        ...
        views.OrganizationDetail.as_view(
            template_name="nhdb/organization_detail_ajax.html"
        ),
        name="detail_ajax",
    ),
    ...
    url(
        r"^(?P<pk>\d+)/description_(?P<language_code>\w+)/$",
        views.organizationdescription,
        name="update_description",
    ),
    # url(r'^(?P<pk>\d+)/places/$', views.organizationplace, name='places'),
    url(
        r"^(?P<organization_id>\d+)/people/$",
        views.organization_persons,
        name="persons",
    ),
]
...
projectperson = [
    ...
    url(
        r"(?P<pk>[0-9]+)/delete/$",
        views.ProjectPersonDelete.as_view(
            template_name="nhdb/projectperson_delete.html"
        ),
        name="detail",
    ),
]
...
project = [
    ...
    url(
        r"^confirm/(?P<suggest_pk>[0-9]+)/$", views.confirmprojectchange, name="confirm"
    ),
    url(r"(?P<pk>[0-9]+)/$", views.ProjectDetail.as_view(), name="detail"),
    url(
        r"(?P<pk>[0-9]+)/organizations/$",
        views.ProjectOrganizations.as_view(),
        name="projectorganizations",
    ),
    url(
        r"^(?P<pk>[0-9]+)/ajax/$",
        views.ProjectDetail.as_view(template_name="nhdb/project_detail_ajax.html"),
        name="project_detail_ajax",
    ),
    url(
        r"^(?P<pk>[0-9]+)/update/description/(?P<language_code>\w+)/$",
        views.projectdescription,
    ),
...
person = [
    ...
    url(
        r"(?P<pk>[0-9]+)/ajax/$",
        views.PersonDetail.as_view(template_name="nhdb/person_detail_ajax.html"),
        name="detail_ajax",
    ),
    url(
        r"new/$",
        views.PersonCreate.as_view(template_name="nhdb/person_create.html"),
        name="new",
    ),
]
...
urlpatterns = [
    ...
    url(
        r"^projectorganization/",
        include(projectorganization, namespace="projectorganization"),
    ),
    ...
    url(
        r"^downloadexcel/list/",
        views.ExcelDownloadFeedbackList.as_view(),
        name="downloadexcel_list",
    ),
