/* eslint-disable vars-on-top,block-scoped-var,no-prototype-builtins,no-plusplus,no-restricted-syntax */
/* globals requirejs */
/**
 * jQuery json-viewer
                ...
                if (key_count > 0) {
                    ...
                    for (var i in json) {
                        if (json.hasOwnProperty(i)) {
                            html += '<li>';
                            // Add toggle button if item is collapsable
                            if (isCollapsable(json[i])) { html += '<a href class="json-toggle">' + i + '</a>'; } else { html += i; }
