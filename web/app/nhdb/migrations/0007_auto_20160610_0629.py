...
class Migration(migrations.Migration):
    ...
    dependencies = [("nhdb", "0006_auto_20160610_0605")]
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="organizationplace", name="suco"),
        migrations.AddField(
            model_name="organizationplacedescription",
            name="organizationplace",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="nhdb.OrganizationPlace"
            ),
        ),
    ]
