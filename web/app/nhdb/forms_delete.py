...
class OrganizationDeleteForm(s):
    ...
    def __init__(self, organization, *args, **kwargs):
        super(OrganizationDeleteForm, self).__init__(
            instance=organization, *args, **kwargs
        )
...
class ProjectImageDeleteForm(s):
    ...
    def __init__(self, projectimage=None, *args, **kwargs):
        super(ProjectImageDeleteForm, self).__init__(
            instance=projectimage, *args, **kwargs
        )
...
class OrganizationPlaceDeleteForm(s):
    ...
    def __init__(self, organizationplace, *args, **kwargs):
        super(OrganizationPlaceDeleteForm, self).__init__(
            instance=organizationplace, *args, **kwargs
        )
...
class ProjectplaceDeleteForm(s):
    ...
    def __init__(self, projectplace, *args, **kwargs):
        super(ProjectplaceDeleteForm, self).__init__(
            instance=projectplace, *args, **kwargs
        )
...
class ProjectPersonDeleteForm(s):
    ...
    def __init__(self, projectperson, *args, **kwargs):
        super(ProjectPersonDeleteForm, self).__init__(
            instance=projectperson, *args, **kwargs
        )
...
class ProjectOrganizationDeleteForm(s):
    ...
    def __init__(self, projectorganization, *args, **kwargs):
        super(ProjectOrganizationDeleteForm, self).__init__(
            instance=projectorganization, *args, **kwargs
        )
