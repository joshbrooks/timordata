...
class NewSuggestionTestCase(TestCase):
    ...
    def test_suggestion_update(self):
        ...
        '''
        c = Client()
        response = c.post('/suggest/suggest/', serialize_dict_to_post(fundingoffer_test_data))
        ...
        assert int(document.status_code) == 201, 'Response code was %s' % response.status_code
